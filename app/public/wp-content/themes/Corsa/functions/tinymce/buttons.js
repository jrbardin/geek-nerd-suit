		...
		init : function(ed, url) {
            ...
            ed.addButton('columns', {
                ...
                menu: [
                        ...
                        menu: [
                            {
                                ...
                                value: '[row]<br />[one_half] ... [/one_half]<br />[one_half] ... [/one_half]<br />[/row]',
                                onclick: function() {
                            ...
                            },
                            {
                                ...
                                value: '[row]<br />[one_third] ... [/one_third]<br />[two_third] ... [/two_third]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[two_third] ... [/two_third]<br />[one_third] ... [/one_third]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[one_quarter] ... [/one_quarter]<br />[three_quarter] ... [/three_quarter]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[three_quarter] ... [/three_quarter]<br />[one_quarter] ... [/one_quarter]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            }
                        ...
                        menu: [
                            {
                                ...
                                value: '[row]<br />[one_third] ... [/one_third]<br />[one_third] ... [/one_third]<br />[one_third] ... [/one_third]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[one_half] ... [/one_half]<br />[one_quarter] ... [/one_quarter]<br />[one_quarter] ... [/one_quarter]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[one_quarter] ... [/one_quarter]<br />[one_quarter] ... [/one_quarter]<br />[one_half] ... [/one_half]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            },
                            {
                                ...
                                value: '[row]<br />[one_quarter] ... [/one_quarter]<br />[one_half] ... [/one_half]<br />[one_quarter] ... [/one_quarter]<br />[/row]',
                                onclick: function() {
                                    ed.insertContent(this.value());
                                }
                            }
                    ...
                    {
                        text: '4 columns',
                        value: '[row]<br />[one_quarter] ... [/one_quarter]<br />[one_quarter] ... [/one_quarter]<br />[one_quarter] ... [/one_quarter]<br />[one_quarter] ... [/one_quarter]<br />[/row]',
                        onclick: function() {
                            ed.insertContent(this.value());
                        }
                    }
	...
	tinymce.create('tinymce.plugins.pricing_table', {
		init : function(ed, url) {
			ed.addButton('pricing_table', {
				...
				onclick : function() {
					ed.selection.setContent('[pricing_table]<br>[pricing_column title="Standard" price="$10" time="per month"]<br>[pricing_row]Feature 1[/pricing_row]<br>[pricing_row]Feature 2[/pricing_row]<br>[pricing_footer url="#" type="default" size="small, big or leave blank for normal"]Signup[/pricing_footer]<br>[/pricing_column]<br><br>[pricing_column title="Business" price="$20" time="per month" type="featured"]<br>[pricing_row]Feature 1[/pricing_row]<br>[pricing_row]Feature 2[/pricing_row]<br>[pricing_footer url="#" type="primary" size="small, big or leave blank for normal"]Signup[/pricing_footer]<br>[/pricing_column]<br>[/pricing_table]');
