...
$us_zilla_shortcodes['portfolio'] = array(
	...
	'shortcode' => '[portfolio items="{{items}}" category="{{category}}" ratio="{{ratio}}"]',
...
$us_zilla_shortcodes['team'] = array(
	...
	'child_shortcode' => array(
		'params' => array(
			...
			'custom_link_external' => array(
				'std' => false,
				'type' => 'checkbox',
				'label' => 'External Custom Link',
				'checkbox_text' => 'Opens Custom Link in new tab',
				'desc' => '',
			),
		),
		'shortcode' => '<br>[member name="{{name}}" role="{{role}}" img="{{img}}" email="{{email}}" facebook="{{facebook}}" twitter="{{twitter}}" linkedin="{{linkedin}}" custom_icon="{{custom_icon}}" custom_link="{{custom_link}}" custom_link_external="{{custom_link_external}}"]',
...
$us_zilla_shortcodes['simple_slider'] = array(
	'params' => array(
		...
		'auto_rotation' => array(
			...
			'type' => 'checkbox',
			'label' => 'Auto Rotation',
			'checkbox_text' => 'Enable Auto Rotation',
			'desc' => '',
		),
		'fullscreen' => array(
			'std' => false,
			'type' => 'checkbox',
			'label' => 'Full Screen',
			'checkbox_text' => 'Allow Full Screen view',
			'desc' => '',
		),
	),
	'no_preview' => true,
	'shortcode' => '[simple_slider arrows="{{arrows}}" nav="{{nav}}" transition="{{transition}}" auto_rotation="{{auto_rotation}}" fullscreen="{{fullscreen}}"] {{child_shortcode}} [/simple_slider]',
	...
	'child_shortcode' => array(
		...
		'shortcode' => '<br>[simple_slide img="{{img}}" alt="{{alt}}"]',
...
$us_zilla_shortcodes['gmaps'] = array(
	...
	'params' => array(
		...
		'api_key' => array(
			...
			'type' => 'text',
			'label' => 'API Key',
			'desc' =>  'Read more information about Google Maps API Key at <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">this page</a>.',
		),
	),
	'shortcode' => '[gmaps address="{{address}}" marker="{{marker}}" height="{{height}}" type="{{type}}" zoom="{{zoom}}" latitude="{{latitude}}" longitude="{{longitude}}" api_key="{{api_key}}"]',
...
$us_zilla_shortcodes['subsection'] = array(
	...
	'params' => array(
		...
		'full_screen' => array(
			...
			'checkbox_text' => 'Expand this subsection to browser window size',
			'desc' => '',
		),
		'valign_center' => array(
			'std' => false,
			'type' => 'checkbox',
			'label' => 'Full Screen Centering',
			'checkbox_text' => 'Center content of this section by vertical',
			'desc' => '',
		),
		'background' => array(
			'std' => '',
        ...
        'video_mp4' => array(
            ...
            'desc' => 'Link to MP4 video file to apply video background to this section',
        ),
        'video_ogg' => array(
            'std' => '',
            'type' => 'text',
            'label' => 'OGG video file',
            'desc' => 'Link to OGG video file to apply video background to this section',
        ),
        'video_webm' => array(
            'std' => '',
            'type' => 'text',
            'label' => 'WebM video file',
            'desc' => 'Link to WebM video file to apply video background to this section',
        ),
		'content' => array(
			'std' => 'You can use other shortcodes here ',
			'type' => 'textarea',
	...
	'shortcode' => '[subsection color="{{color}}" full_width="{{full_width}}" full_height="{{full_height}}" '.
				   'full_screen="{{full_screen}}" valign_center="{{valign_center}}" background="{{background}}" '.
				   'parallax="{{parallax}}" video="{{video}}" video_mp4="{{video_mp4}}" video_ogg="{{video_ogg}}" '.
				   'video_webm="{{video_webm}}"]<br>{{content}}<br>[/subsection]',
...
$us_zilla_shortcodes['clients'] = array(
    ...
    'params' => array(
        'auto_scroll' => array(
            ...
            'type' => 'checkbox',
            'label' => 'Auto Scroll',
            'checkbox_text' => 'Auto Scroll Clients Logos',
            'desc' => '',
        ),
        'interval' => array(
            'std' => '1',
    ...
    'shortcode' => '[clients auto_scroll="{{auto_scroll}}" interval="{{interval}}"]',
